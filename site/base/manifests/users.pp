...
class base::users {
  ...
  ssh_authorized_key { 'work-lappy':
    ...
    user   => 'j0sh3rs',
    type   => 'ecdsa-sha2-nistp521',
    key    => 'AAAE2VjZHNhLXNoYTItbmlzdHA1MjEAAAAIbmlzdHA1MjEAAACFBABlbFzDFFfdUPekjXtAhlASJ5ZBf6HTmKWuxR3e/w/ztinZZuTbg4CQUAjvOK2WUWKOGOS0bcyKV8eaamFz7laQhQG7uoR+Xn/4U9arfOeI42TW74929rSBTfcQMC7WNr4NnhagpLt3F8gtu6x/9+QibL58A2xen23HHjAzr4KR5SQkjw==',
  }
